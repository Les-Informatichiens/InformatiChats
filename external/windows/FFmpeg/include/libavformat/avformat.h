...
attribute_deprecated
        int64_t
        av_stream_get_end_pts(const AVStream* st);
#endif
 ...
 */
attribute_deprecated int av_stream_add_side_data(AVStream* st, enum AVPacketSideDataType type,
...
attribute_deprecated
        uint8_t*
        av_stream_get_side_data(const AVStream* stream,
                                enum AVPacketSideDataType type, size_t* size);
#endif
