 ...
 */
attribute_deprecated struct SwrContext* swr_alloc_set_opts(struct SwrContext* s,
 ...
 */
attribute_deprecated int swr_build_matrix(uint64_t in_layout, uint64_t out_layout,
